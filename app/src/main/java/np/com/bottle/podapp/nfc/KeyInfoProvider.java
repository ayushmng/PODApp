...
public class KeyInfoProvider {
     ...
     */
    public void setKey(final String alias, final NfcAppKeys.EnumKeyType keyType, final byte[] key) {
     ...
     * @return IKeyData
     */
    public IKeyData getKey(final String alias, final NfcAppKeys.EnumKeyType keyType) {
        /**
         ...
         */
        if (keyType == NfcAppKeys.EnumKeyType.EnumMifareKey) {
            return null;
        }
