...
public class SpongyCastleKeystoreHelper {
     ...
     */
    public void storeKey(final byte[] key, final String alias, final NfcAppKeys.EnumKeyType keyType)
    ...
    private void storeToKeystoreFile(final byte[] key, final String alias,
                                     final NfcAppKeys.EnumKeyType keyType, final String algorithmType) {

        if (keyType
                == NfcAppKeys.EnumKeyType.EnumMifareKey)  //Bouncy castle does not support custom MIFARE keys.
        {
